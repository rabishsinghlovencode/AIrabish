...
Summarizes a sample report resource.
...
## Typical flow
1. Read report resource\n2. Use it in Inspector or another LLM client for summarization\n3. Keep the answer grounded

## Expected outcome
Sample report content displayed.
