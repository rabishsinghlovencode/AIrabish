...
Reads FAQ resource and lets model answer from it.
...
## Typical flow
1. Read FAQ resource\n2. Use the content to answer questions manually or in an LLM client\n3. Stay grounded in the text

## Expected outcome
FAQ content is available for grounded answers.
